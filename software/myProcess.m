classdef myProcess
    ...
    methods
        function obj=myProcess(preobj,varargin)
            ...
            if ~isempty(varargin)
                ...
                elseif strcmp(varargin{1},'TSVD')==1
                    ...
                    aa=preobj.sup.aspect;
                    aa(:)=varargin{1};
                    preobj.sup.aspect=aa;
            ...
            if strcmp(preobj.cons,'spf')==1 || strcmp(preobj.cons,'apf')==1
            ...
            elseif strcmpi('insar',preobj.tech)==1
                a.a=preobj.m.ascending_los;a.d=preobj.m.descending_los*0.1;
            end
        ...
        function A=make_A(obj,preobj,i,j)
            ...
            if strcmp(preobj.cons,'spf')==1
                ddew=preobj.sup.dem_ddew;
                ddns=preobj.sup.dem_ddns;
            elseif strcmp(preobj.cons,'apf')==1
                as=preobj.sup.aspect;
                % as(:)=30;
            end
            ...
            if strcmpi('POT',preobj.tech)==1
                ...
                elseif strcmp(preobj.cons,'apf')==1
                    for k=obj.aspect.a*2+1+obj.aspect.d*2:obj.aspect.d*2+obj.aspect.a*2+obj.aspect.spf
                        q=k-obj.aspect.a*2-obj.aspect.d*2;
                        A(k,3*(q-1)+1)=sind(as(i,j));
                        A(k,3*(q-1)+2)=-cosd(as(i,j));
                        A(k,3*(q-1)+3)=0;
                        clear q
                    end
                end
